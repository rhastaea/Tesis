...
##################################### CREAR DATACAM_DELTA - TABLA DE IMÁGENES/ESPECIES ######
...
##################################### HISTOGRAMA RADIAL!! ####
registers <- datacam_abril #Acá el script original llama "registers" a nuestro datacam. Decidí dejarlo así porque toca algunas cosas de la tabla y así no me modifica datacam.
